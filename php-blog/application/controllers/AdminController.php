 ...
 * Компонент для работы с администраторской частью сайта
 */
...
class AdminController extends Controller {
    ...
    //Подключение шаблона администратора
	public function __construct($route) {
		parent::__construct($route);
		$this->view->layout = 'admin';
	}

	//Авторизация в кабинет администратора
	...
	//Редактирует пост из базы данных по конкретному id
	...
	//Удаляет пост из базы данных по конкретному id
